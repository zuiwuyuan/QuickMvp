...
public class ReftitTextView extends AppCompatTextView {
    private static final String TAG = "ReftitTextView";
    private float preferredTextSize;
    private float minTextSize;
    private Paint textPaint;

    public ReftitTextView(Context context) {
//        super(context, null);
        this(context, null);
    }

    public ReftitTextView(Context context, AttributeSet attrs) {
//        super(context, attrs);
        this(context, attrs, R.attr.autoScaleTextViewStyle);
    }

    public ReftitTextView(Context context, AttributeSet attrs, int defStyleAttr) {
