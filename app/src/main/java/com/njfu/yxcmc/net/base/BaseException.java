...
public class BaseException extends IOException {
    ...
    public static final String BAD_NETWORK_MSG = "网络错误";
    /**
     * 连接错误
     */
     ...
     * SSL证书错误
     */
    public static final int HTTPS_HANDSHAKE_FAILED = 1005;
    public static final String HTTPS_HANDSHAKE_FAILED_MSG = "SSL证书错误";
